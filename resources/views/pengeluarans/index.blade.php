<x-layouts.app>
    ...
    <div class="mb-6 flex justify-between items-center">
        <div>
            <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Pengeluaran</h1>
            <p class="text-gray-600 dark:text-gray-400 mt-1">Manage System Pengeluaran</p>
        </div>
    ...
    <script>
        $(document).ready(function() {
            $('#dynamic-table').DataTable({
                ...
                language: {
                    search: "_INPUT_",
                    searchPlaceholder: "Search Pengeluaran...",
                    lengthMenu: "Show _MENU_ entries",
                    info: "Showing _START_ to _END_ of _TOTAL_ Pengeluaran",
                    infoEmpty: "No Pengeluaran found",
                    infoFiltered: "(filtered from _MAX_ total Pengeluaran)",
                    zeroRecords: "No matching Pengeluaran found",
                    emptyTable: "No Pengeluaran available"
                },
