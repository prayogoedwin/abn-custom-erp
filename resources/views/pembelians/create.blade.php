<x-layouts.app>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const supplierSelect = document.querySelector('select.searchable-select');
            ...
            if (supplierSelect) {
                new TomSelect(supplierSelect, {
                    ...
                    placeholder: supplierSelect.getAttribute('placeholder') || 'Ketik nama supplier...',
                    render: {
                        no_results: function() {
