<x-layouts.app>
    <div class="mb-6 flex items-center text-sm">
        ...
        <span class="text-gray-500 dark:text-gray-400">Stok Titipan</span>
    </div>

    <div class="mb-6 flex justify-between items-center">
        <div>
            <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Stok Titipan</h1>
            <p class="text-gray-600 dark:text-gray-400 mt-1">Manage System Stok Titipan</p>
        </div>
    ...
    <script>
        $(document).ready(function() {
            $('#dynamic-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route("stoktitipans.indexTable") }}',
                columns: [
                ...
                language: {
                    search: "_INPUT_",
                    searchPlaceholder: "Search Stok Titipan",
                    lengthMenu: "Show _MENU_ entries",
                    info: "Showing _START_ to _END_ of _TOTAL_ Stok Titipan",
                    infoEmpty: "No Stok Titipan found",
                    infoFiltered: "(filtered from _MAX_ total Stok Titipan)",
                    zeroRecords: "No matching Stok Titipan found",
                    emptyTable: "No Stok Titipan available"
                },
