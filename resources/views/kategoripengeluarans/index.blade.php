<x-layouts.app>
    <div class="mb-6 flex items-center text-sm">
        ...
        <span class="text-gray-500 dark:text-gray-400">Kategori Pengeluaran</span>
    </div>

    <div class="mb-6 flex justify-between items-center">
        <div>
            <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Kategori Pengeluaran</h1>
            <p class="text-gray-600 dark:text-gray-400 mt-1">Manage System Kategori Pengeluaran</p>
        </div>
            ...
            <table id="dynamic-table" class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead class="bg-gray-50 dark:bg-gray-900">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">created_at</th>
    ...
    <script>
        $(document).ready(function() {
            $('#dynamic-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route("kategori-pengeluarans.indexTable") }}',
                ...
                order: [
                    [1, 'desc'] //sort by created_at
                ],
                language: {
                    search: "_INPUT_",
                    searchPlaceholder: "Search Kategori Pengeluaran...",
                    lengthMenu: "Show _MENU_ entries",
                    info: "Showing _START_ to _END_ of _TOTAL_ Kategori Pengeluaran",
                    infoEmpty: "No Kategori Pengeluaran found",
                    infoFiltered: "(filtered from _MAX_ total Kategori Pengeluaran)",
                    zeroRecords: "No matching Kategori Pengeluaran found",
                    emptyTable: "No Kategori Pengeluaran available"
                },
