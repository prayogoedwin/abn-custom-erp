<x-layouts.app>
    <div class="mb-6 flex items-center text-sm">
        ...
        <a href="{{ route('kategori-pengeluarans.index') }}" class="text-blue-600 dark:text-blue-400 hover:underline">{{ $title ?? __('Kategori Pengeluaran') }}</a>
        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mx-2 text-gray-400" fill="none" viewBox="0 0 24 24"
            stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
        </svg>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        <div class="p-6 min-h-[500px]">
            <form action="{{ route('kategori-pengeluarans.store') }}" method="POST" class="max-w-3xl">
                @csrf
                @method('POST')
                ...
                <div class="mb-5">
                    ...
                    <select
                        ...
                        <option value="" selected >Tidak di isi</option>
