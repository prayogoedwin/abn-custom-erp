        ...
        <div class="p-5">
            <form action="{{ route($tablename . '.update', $data) }}" method="POST" id="pembelianForm">
                ...
                <div class="flex gap-3 mt-3 border-t pt-4">
                    ...
                    <a href="{{ route('pengirimans.index') }}" class="text-white font-medium py-2 px-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors flex items-center justify-center cursor-pointer bg-gray-600 hover:bg-gray-700 focus:ring-gray-500 dark:bg-gray-500 dark:hover:bg-gray-600">
                        {{ __('Batal') }}
                    </a>
                </div>
            </form>
