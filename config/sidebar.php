    ...
    [
        ...
        'children' => [
            ...
            [
                ...
                'icon' => 'fas-file-invoice-dollar',
                'route' => 'laporantitipanbarangs.index',
                'active' => 'laporantitipanbarangs*',
                'permission' => 'view-laporan',
            ],
            [
                'title' => 'Bon Supplier',
                'icon' => 'fas-file-invoice-dollar',
                'route' => 'laporanbonsuppliers.index',
                'active' => 'laporanbonsuppliers*',
                'permission' => 'view-laporan',
            ],
            [
                'title' => 'Ritan',
                'icon' => 'fas-file-invoice-dollar',
                'route' => 'laporanritans.index',
                'active' => 'laporanritans*',
                'permission' => 'view-laporan',
            ],
            [
                'title' => 'Titipan Ke Customer',
                'icon' => 'fas-file-invoice-dollar',
                'route' => 'laporantitipankecustomers.index',
                'active' => 'laporantitipankecustomers*',
                'permission' => 'view-laporan',
            ],
            [
                'title' => 'Transaksi Kas',
            ...
            [
                ...
                'icon' => 'fas-file-invoice-dollar',
                'route' => 'laporankasbonkaryawans.index',
                'active' => 'laporankasbonkaryawans*',
                'permission' => 'view-laporan',
            ],
            [
                'title' => 'Transaksi Pihak Ketiga',
                'icon' => 'fas-file-invoice-dollar',
                'route' => 'laporantransaksipihakketigas.index',
                'active' => 'laporantransaksipihakketigas*',
                'permission' => 'view-laporan',
            ],
            [
                'title' => 'Biaya Semua',
                'icon' => 'fas-file-invoice-dollar',
                'route' => 'laporanbiayas.index',
                'active' => 'laporanbiayas*',
                'permission' => 'view-laporan',
            ],
            [
                'title' => 'Rugi Laba',
                'icon' => 'fas-file-invoice-dollar',
                'route' => 'laporanrugilabas.index',
                'active' => 'laporanrugilabas*',
                'permission' => 'view-laporan',
            ],
